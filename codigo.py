...
class MainScr(Screen):
  def __init__(self, **kwargs):
      ...
      hl = BoxLayout()
      txt = Label(text= 'Escoger una pantalla')
...
class FirstScr(Screen):
  def __init__(self, **kwargs):
      ...
      btn = Button(text= 'Elección: 1', size_hint=(.5, 1), pos_hint={'left': 0})
...
class SecondScr(Screen):
  def __init__(self, **kwargs):
      ...
      self.txt = Label(text= 'Elección: 2')
      ...
      lbl1 = Label(text='Ingresar contraseña:', halign='right')
...
class FourthScr(Screen):
  def __init__(self, **kwargs):
      ...
      a = 'INICIO ' + 'Elección: 3 ' * 200
      test_label = Label(text = "Ejercicios extra",size_hint=(0.3,None))
